# Climbing Training Android App - Specification

## Overview

Android app built with **Kotlin + Jetpack Compose** that hosts tools for climbing exercises. The app starts with a home screen listing all available tools. The first tool is **Flying Loto**.
...
- **Persistence**: SharedPreferences (player names)
...
- App title: "Climbing Training"
- List of available tools displayed as cards
- Each card shows: tool name, short description, icon
- First (and only for now) tool: **Flying Loto**
- Tapping a card navigates to the tool
